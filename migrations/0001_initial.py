# Generated by Django 5.0.6 on 2024-11-15 16:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, help_text='A description of the patron', verbose_name='description')),
            ],
            options={
                'ordering': ('name_full',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(blank=True, help_text='A title for the banaction (ex, help Brenda with her tablet)', max_length=255, verbose_name='title')),
                ('banaction_summary', models.CharField(blank=True, help_text="A summary of the bannee's request", max_length=255, verbose_name='request summary')),
                ...
                ('when_lifted', models.DateField(blank=True, help_text='The date and time the banaction is lifted', null=True, verbose_name='when lifted')),
